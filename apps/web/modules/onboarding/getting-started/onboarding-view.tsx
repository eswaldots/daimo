...
export const OnboardingView = () => {
		return (
				<motion.section className="flex flex-col gap-10 items-center w-full"
				exit={{ opacity: 0 }}
				>
                <motion.div
                  className="p-6 bg-foreground rounded-3xl w-fit mx-auto flex items-center justify-center"
				...
				className="text-4xl md:text-5xl font-semibold tracking-tight">Bienvenido a Daimo</motion.h1>
				...
				>
Aprendizaje infantil impulsado por modelos de lenguaje avanzados. Sin pantallas. Privacidad por diseño.
				</motion.p>
				</div>
				<motion.div
                  initial={{ opacity: 0,  y: -20  }}
				...
				>
				<Button className="h-12 w-full rounded-xl md:w-md text-base" size='lg' asChild>
