  ...
  return (
    ...
    >
      <div className="flex flex-1">
        <SettingsSidebar session={data} />
        <SidebarInset className="relative bg-background">
          <div className="flex flex-1 flex-col mx-auto max-w-5xl w-full">
            <div className="@container/main flex flex-1 flex-col gap-2">
              <div className="flex flex-col gap-4 py-4 md:gap-4 md:py-10 md:pt-24 pt-24 md:px-10 px-4">
                <Trigger />
